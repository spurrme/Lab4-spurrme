...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        [Test()]
        public void TestThatUserDoesRemoveFlightWhenIsBooked()
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2009, 11, 1), new DateTime(2009, 12, 1), 700);
            var remainingFlight = new Flight(new DateTime(2009, 11, 1), new DateTime(2009, 11, 11), 800);
